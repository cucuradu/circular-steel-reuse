...
Trained on the synthetic dataset (:mod:`experiments.ml.synthetic`). Intended as a cheap *pre-screen* of
large supply x demand grids before the exact EN 1993 check confirms survivors — but it is **not wired
into the pipeline** (it is an exploratory study under ``experiments/ml/``, outside the installed package).

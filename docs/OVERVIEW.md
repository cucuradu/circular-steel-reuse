...
published section data and protected by 522 automated tests. The tool is scoped as member‑level
...
**Automated suite.** 522 tests (across forty files) pass under a clean linter, covering the member
